...
class GmyBuilder(object):
    ...
    def _write_preamble(self):
        ...
        p.pack_uint(self.HEMELB_MAGIC_NUMBER)
        p.pack_uint(self.GMY_MAGIC_NUMBER)
...
if __name__ == '__main__':
    ...
    p.add_argument('octfile',
                       help='Input HemeLB octree file to convert to GMY')
    p.add_argument('gmyfile', nargs='?',
                       help='Output GMY file, default is basename(input) + .gmy')
    args = p.parse_args()
