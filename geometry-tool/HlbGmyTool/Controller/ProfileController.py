...
class ProfileController(
    HasIoletListKeys, HasVectorKeys, HasVtkObjectKeys, ObjectController
):
    """Proxy for HlbGmyTool.Mode.Profile objects."""
    ...
    def ChooseOutputGeometryFile(self, ignored=None):
        dialog = wx.FileDialog(
            None, style=wx.FD_SAVE | wx.FD_OVERWRITE_PROMPT, wildcard="*.gmy"
        )
    ...
    def ChooseOutputXmlFile(self, ignored=None):
        dialog = wx.FileDialog(
            None, style=wx.FD_SAVE | wx.FD_OVERWRITE_PROMPT, wildcard="*.xml"
        )
    ...
    def ChooseSaveFile(self, ignored=None):
        dialog = wx.FileDialog(
            None, style=wx.FD_SAVE | wx.FD_OVERWRITE_PROMPT, wildcard="*.pr2"
        )
