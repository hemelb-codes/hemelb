...
METHOD_AS_TEST_CASE(SurfaceVoxeliserTests::NeighbourInverses, "NeighbourInverses", "[SurfaceVoxeliser]");
METHOD_AS_TEST_CASE(SurfaceVoxeliserTests::Trivial, "TrivialSurfaceVoxelisation", "[SurfaceVoxeliser]");
METHOD_AS_TEST_CASE(SurfaceVoxeliserTests::SphereIntersections, "SphereIntersections", "[SurfaceVoxeliser]");
METHOD_AS_TEST_CASE(SurfaceVoxeliserTests::Sphere, "SphereSurfaceVoxelisation", "[SurfaceVoxeliser]");
