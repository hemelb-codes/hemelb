...
METHOD_AS_TEST_CASE(SectionTreeTests::LocalOffsets, "LocalOffsets", "[SectionTree]");
METHOD_AS_TEST_CASE(SectionTreeTests::TinyFullTree, "TinyFullTree", "[SectionTree]");
METHOD_AS_TEST_CASE(SectionTreeTests::TinyCentreTree, "TinyCentreTree", "[SectionTree]");
METHOD_AS_TEST_CASE(SectionTreeTests::Sphere, "SphereSectionTree", "[SectionTree]");
