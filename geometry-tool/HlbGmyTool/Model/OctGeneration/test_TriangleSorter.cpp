...
METHOD_AS_TEST_CASE(TriangleSorterTests::TrivialDeep, "TrivialDeep", "[triangle]");
METHOD_AS_TEST_CASE(TriangleSorterTests::Sphere, "Sphere", "[triangle]");
METHOD_AS_TEST_CASE(TriangleSorterTests::MergeIdentity, "MergeIdentity", "[triangle]");
METHOD_AS_TEST_CASE(TriangleSorterTests::MergeSimple, "MergeSimple", "[triangle]");
METHOD_AS_TEST_CASE(TriangleSorterTests::ParallelTrivial, "ParallelTrivial", "[triangle]");
METHOD_AS_TEST_CASE(TriangleSorterTests::ParallelSphere, "ParallelSphere", "[triangle]");
