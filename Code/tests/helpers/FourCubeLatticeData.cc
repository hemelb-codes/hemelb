...
namespace hemelb
{
  namespace tests
  {
     ...
     * @return
     */
    FourCubeLatticeData* FourCubeLatticeData::Create(comm::Communicator::ConstPtr comm, site_t sitesPerBlockUnit, proc_t rankCount)
    {
...
// Origin                                               util::Vector3D<PhysicalDistance>::Zero());
	...
	* sitesAlongCube;
    ...
    FourCubeLatticeData::FourCubeLatticeData(hemelb::geometry::Geometry& readResult, comm::Communicator::ConstPtr comms) :
