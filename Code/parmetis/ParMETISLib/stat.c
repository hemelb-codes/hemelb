...
void Mc_ComputeRefineStats(CtrlType *ctrl, GraphType *graph, float *ubvec)
{
  ...
  if (mype == 0) { 
    ...
    for (i=0; i<nparts; i++) {
      printf("%d: ", i);
      for (j=0; j<nparts; j++)
        printf("%9" IDXTYPE_FORMAT " ", gconnect[i*nparts+j]);
      printf("\n");
    }
    printf("\n");
  }
  ...
  if (mype == 0) {
    ...
    for (i=0; i<nparts; i++)
      printf("%9" IDXTYPE_FORMAT " ", gborder[i]);
    printf("\n\n");
  }
  ...
  if (mype == 0) {
    ...
    printf("from   ");
    for (i=0; i<nparts; i++) {
      printf("%9" IDXTYPE_FORMAT " ", gfrom[i]);
    }
    printf("\n");
    printf("to     ");
    for (i=0; i<nparts; i++) {
      printf("%9" IDXTYPE_FORMAT " ", gto[i]);
    }
    printf("\n\n");
  }
