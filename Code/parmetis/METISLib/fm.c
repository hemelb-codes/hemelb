...
void FM_2WayEdgeRefine(CtrlType *ctrl, GraphType *graph, int *tpwgts, int npasses)
{
  ...
  IFSET(ctrl->dbglvl, DBG_REFINE, 
     printf("Partitions: [%6" IDXTYPE_FORMAT " %6" IDXTYPE_FORMAT "] T[%6d %6d], Nv-Nb[%6d %6d]. ICut: %6d\n",
  ...
  for (pass=0; pass<npasses; pass++) { /* Do a number of passes */
    ...
    for (nswaps=0; nswaps<nvtxs; nswaps++) {
      ...
      IFSET(ctrl->dbglvl, DBG_MOVEINFO, 
        printf("Moved %6d from %d. [%3" IDXTYPE_FORMAT " %3" IDXTYPE_FORMAT "] %5d [%4" IDXTYPE_FORMAT " %4"IDXTYPE_FORMAT"]\n", higain, from, ed[higain]-id[higain], vwgt[higain], newcut, pwgts[0], pwgts[1]));
    ...
    *****************************************************************/
    ...
    IFSET(ctrl->dbglvl, DBG_REFINE, 
      printf("\tMinimum cut: %6d at %5d, PWGTS: [%6" IDXTYPE_FORMAT " %6" IDXTYPE_FORMAT "], NBND: %6d\n", mincut, mincutorder, pwgts[0], pwgts[1], nbnd));
