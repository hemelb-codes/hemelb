...
void Bnd2WayBalance(CtrlType *ctrl, GraphType *graph, int *tpwgts)
{
  ...
  IFSET(ctrl->dbglvl, DBG_REFINE, 
     printf("Partitions: [%6" IDXTYPE_FORMAT " %6" IDXTYPE_FORMAT "] T[%6d %6d], Nv-Nb[%6d %6d]. ICut: %6d [B]\n",
  ...
  IFSET(ctrl->dbglvl, DBG_REFINE, 
    printf("\tMinimum cut: %6d, PWGTS: [%6" IDXTYPE_FORMAT " %6" IDXTYPE_FORMAT "], NBND: %6d\n", mincut, pwgts[0], pwgts[1], nbnd));
