...
void FM_2WayNodeRefine_OneSided(CtrlType *ctrl, GraphType *graph, float ubfactor, int npasses)
{
  ...
  IFSET(ctrl->dbglvl, DBG_REFINE,
    printf("Partitions-N1: [%6" IDXTYPE_FORMAT " %6" IDXTYPE_FORMAT "] Nv-Nb[%6d %6d]. ISep: %6d\n", pwgts[0], pwgts[1], graph->nvtxs, graph->nbnd, graph->mincut));
...
void FM_2WayNodeBalance(CtrlType *ctrl, GraphType *graph, float ubfactor)
{
  ...
  IFSET(ctrl->dbglvl, DBG_REFINE,
    printf("Partitions: [%6" IDXTYPE_FORMAT " %6" IDXTYPE_FORMAT "] Nv-Nb[%6d %6d]. ISep: %6d [B]\n", pwgts[0], pwgts[1], graph->nvtxs, graph->nbnd, graph->mincut));
  ...
  *******************************************************/
  for (nswaps=0; nswaps<nvtxs; nswaps++) {
    ...
    IFSET(ctrl->dbglvl, DBG_MOVEINFO,
          printf("Moved %6d to %3d, Gain: %3" IDXTYPE_FORMAT ", \t[%5" IDXTYPE_FORMAT " %5" IDXTYPE_FORMAT " %5" IDXTYPE_FORMAT "]\n", higain, to, vwgt[higain]-rinfo[higain].edegrees[other], pwgts[0], pwgts[1], pwgts[2]));
  ...
  IFSET(ctrl->dbglvl, DBG_REFINE,
    printf("\tBalanced sep: %6" IDXTYPE_FORMAT " at %4d, PWGTS: [%6" IDXTYPE_FORMAT " %6" IDXTYPE_FORMAT "], NBND: %6d\n", pwgts[2], nswaps, pwgts[0], pwgts[1], nbnd));
