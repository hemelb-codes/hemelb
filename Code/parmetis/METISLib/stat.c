...
void ComputePartitionInfo(GraphType *graph, int nparts, idxtype *where)
{
  ...
  printf("Min/Max/Avg/Bal # of adjacent     subdomains: %5" IDXTYPE_FORMAT " %5" IDXTYPE_FORMAT " %5.2f %7.3f\n",
  ...
  printf("Min/Max/Avg/Bal # of adjacent subdomain cuts: %5" IDXTYPE_FORMAT " %5" IDXTYPE_FORMAT " %5d %7.3f\n",
  ...
  printf("Min/Max/Avg/Bal/Frac # of interface    nodes: %5" IDXTYPE_FORMAT " %5" IDXTYPE_FORMAT " %5d %7.3f %7.3f\n",
    kpwgts[idxamin(nparts, kpwgts)], kpwgts[idxamax(nparts, kpwgts)], idxsum(nparts, kpwgts)/nparts, 
...
void ComputePartitionInfoBipartite(GraphType *graph, int nparts, idxtype *where)
{
  ...
  for (i=0; i<nparts; i++)
    kpwgts[i] = idxsum(nparts, padjncy+i*nparts);
  printf("Min/Max/Avg/Bal # of adjacent     subdomains: %5" IDXTYPE_FORMAT " %5" IDXTYPE_FORMAT " %5d %7.3f\n",
    kpwgts[idxamin(nparts, kpwgts)], kpwgts[idxamax(nparts, kpwgts)], idxsum(nparts, kpwgts)/nparts, 
    1.0*nparts*kpwgts[idxamax(nparts, kpwgts)]/(1.0*idxsum(nparts, kpwgts)));
