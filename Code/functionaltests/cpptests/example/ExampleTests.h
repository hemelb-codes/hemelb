#ifndef HEMELB_FUNCTIONALTESTS_EXAMPLE_EXAMPLETESTS_H
#define HEMELB_FUNCTIONALTESTS_EXAMPLE_EXAMPLETESTS_H
...
#endif  //HEMELB_FUNCTIONALTESTS_EXAMPLE_EXAMPLETESTS_H
