...
#ifndef HEMELB_LB_STREAMERS_ADVECTIONDIFFUSIONOUTFLOWBASESTREAMERDELEGATE_H
#define HEMELB_LB_STREAMERS_ADVECTIONDIFFUSIONOUTFLOWBASESTREAMERDELEGATE_H
...
namespace hemelb
{
  namespace lb
  {
    namespace streamers
    {
      ...
      class AdvectionDiffusionOutflowBaseStreamerDelegate
      {
        public:
        ...
        protected:
           ...
           */
          AdvectionDiffusionOutflowBaseStreamerDelegate()
          {
          }
        public:
          /**
...
#endif /* HEMELB_LB_STREAMERS_ADVECTIONDIFFUSIONOUTFLOWBASESTREAMERDELEGATE_H */
