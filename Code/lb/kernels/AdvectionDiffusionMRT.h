...
#ifndef HEMELB_LB_KERNELS_ADVECTIONDIFFUSIONMRT_H
#define HEMELB_LB_KERNELS_ADVECTIONDIFFUSIONMRT_H
...
namespace hemelb
{
  namespace lb
  {
    namespace kernels
    {
      ...
      template<class MomentBasis> class AdvectionDiffusionMRT;

      template<class MomentBasis>
      struct HydroVars<AdvectionDiffusionMRT<MomentBasis> > : public HydroVarsBase<typename MomentBasis::Lattice>
      {
        public:
       ...
       */
      template<class MomentBasis>
      class AdvectionDiffusionMRT : public AdvectionDiffusionBaseKernel<AdvectionDiffusionMRT<MomentBasis>, typename MomentBasis::Lattice>
      {
        public:

          AdvectionDiffusionMRT(InitParams& initParams)
          {
          ...
          inline void DoCollide(const LbmParameters* const lbmParams, HydroVars<AdvectionDiffusionMRT>& hydroVars)
          {
            for (Direction direction = 0; direction < MomentBasis::Lattice::NUMVECTORS; ++direction)
            {
...
#endif /* HEMELB_LB_STREAMERS_ADVECTIONDIFFUSIONMRT_H */
