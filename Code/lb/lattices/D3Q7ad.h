...
#ifndef HEMELB_LB_LATTICES_D3Q7AD_H
#define HEMELB_LB_LATTICES_D3Q7AD_H

#include "lb/lattices/AdvectionDiffusionLattice.h"
...
namespace hemelb
{
  namespace lb
  {
    namespace lattices
    {
      ...
      class D3Q7ad : public hemelb::lb::lattices::AdvectionDiffusionLattice<D3Q7ad>
      {
        public:
          // The number of discrete velocity vectors
          static const Direction NUMVECTORS = 7;
...
#endif /* HEMELB_LB_LATTICES_D3Q7AD_H */
