...
#ifndef HEMELB_LB_IOLETS_INOUTLETHOLLOWFILEVELOCITY_H
#define HEMELB_LB_IOLETS_INOUTLETHOLLOWFILEVELOCITY_H
...
namespace hemelb
{
  namespace lb
  {
    namespace iolets
    {
      ...
      class InOutLetHollowFileVelocity : public InOutLetVelocity
      {
        public:
          InOutLetHollowFileVelocity();
...
#endif /* HEMELB_LB_IOLETS_INOUTLETHOLLOWFILEVELOCITY_H */
