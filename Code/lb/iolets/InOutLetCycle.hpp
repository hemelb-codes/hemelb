...
#ifndef HEMELB_LB_IOLETS_INOUTLETCYCLE_HPP
#define HEMELB_LB_IOLETS_INOUTLETCYCLE_HPP
...
namespace hemelb
{
  namespace lb
  {
    namespace iolets
    {
      template<unsigned long updatePeriod, bool comms> void InOutLetCycle<updatePeriod, comms>::DoComms(
                                                                                                        bool is_io_proc,
