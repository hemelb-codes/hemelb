...
#define HEMELB_ADE_WALL_BOUNDARY ADVECTIONDIFFUSIONVWADIRICHLET
...
#define HEMELB_ADE_WALL_INLET_BOUNDARY ADVECTIONDIFFUSIONVWAWALLINLETDIRICHLETDIRICHLET
#define HEMELB_ADE_WALL_OUTLET_BOUNDARY ADVECTIONDIFFUSIONVWAWALLOUTFLOWBOUNCEBACKIOLETDIRICHLET
#include "net/net.h"
