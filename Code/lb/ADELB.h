...
#define HEMELB_ADE_WALL_BOUNDARY ADVECTIONDIFFUSIONVWACOATINGCONCENTRATION
#define HEMELB_ADE_INLET_BOUNDARY ADVECTIONDIFFUSIONINLETDIRICHLET
#define HEMELB_ADE_OUTLET_BOUNDARY ADVECTIONDIFFUSIONOUTFLOWBOUNCEBACKIOLET
#define HEMELB_ADE_WALL_INLET_BOUNDARY ADVECTIONDIFFUSIONVWAWALLINLETDIRICHLETCOATINGCONCENTRATION
#define HEMELB_ADE_WALL_OUTLET_BOUNDARY ADVECTIONDIFFUSIONVWAWALLOUTFLOWBOUNCEBACKIOLETCOATINGCONCENTRATION
#include "net/net.h"
