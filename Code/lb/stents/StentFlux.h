...
#ifndef HEMELB_LB_STENTS_STENTFLUX_H
#define HEMELB_LB_STENTS_STENTFLUX_H
    ...
    namespace stents
    {
      class StentFlux : public Stent
      {
        public:
          ...
          virtual LatticeSpeed GetFlux(const LatticeTimeStep t) const = 0;
...
#endif // HEMELB_LB_STENTS_STENTFLUX_H
