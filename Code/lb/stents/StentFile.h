...
#ifndef HEMELB_LB_STENTS_STENTFILE_H
#define HEMELB_LB_STENTS_STENTFILE_H
    ...
    namespace stents
    {
      ...
      class StentFile : public Stent
      {
        public:
          ...
          {
            return densityFilePath;
          }
          void SetFilePath(const std::string& path)
          {
            densityFilePath = path;
          }
...
#endif /* HEMELB_LB_STENTS_STENTFILE_H */
