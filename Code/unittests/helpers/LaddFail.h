...
#define LADD_FAIL() if (std::strcmp(HEMELB_UNITTESTS_HELPERS_LADDFAIL_QQ(HEMELB_IOLET_BOUNDARY), "LADDIOLET") == 0) CPPUNIT_ASSERT_MESSAGE("This test has been marked as fatal when HemeLB is built with LADDIOLET. See ticket #605.", 1 == 0)
