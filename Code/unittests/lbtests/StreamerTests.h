                ...
                += 0.5)
            {
              ...
              for (unsigned int streamedDirection = 0; streamedDirection < D3Q15::NUMVECTORS; ++streamedDirection)
              {
                ...
                if (!streamer.HasBoundary(streamedDirection) && streamedIndex >= 0 && streamedIndex
                    < (D3Q15::NUMVECTORS * latDat->GetLocalFluidSiteCount()))
                {
                ...
                // opposite direction.
                if (streamedDirection == chosenDoubleWallDirection1 || streamedDirection
