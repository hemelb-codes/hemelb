...
#         endif 
      ...
      {
        CellContainer cells;
        CellArmy<Traits> army(*latDat, cells, BuildTemplateContainer(cells), *timers, cutoff, halo);
      ...
      void CellArmyTests::testCellOutput()
      {
        ...
        CellContainer intel;
        intel.insert(cell);
        CellArmy<Traits> army(*latDat, intel, BuildTemplateContainer(intel), *timers, cutoff, halo);
