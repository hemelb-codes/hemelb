    ...
    namespace redblood
    {
      class StencilTests : public CppUnit::TestFixture
      {
        ...
        void test4point()
        {
          ...
          Dimensionless const x[] = {0,          1. - 1e-8, 1. + 1e-8, -1. - 1e-8,
                                     -1. + 1e-8, 2. - 1e-8, 2. + 1e-8, -2. - 1e-8,
                                     -2. + 1e-8, 2.1,       -2.1,      1e8};
        ...
        void test3point()
        {
          ...
          Dimensionless const x[] = {
            0,          0.5 - 1e-8,  0.5 + 1e-8,  -0.5 - 1e-8, -0.5 + 1e-8, 1.5 - 1e-8,
        ...
        void test2point()
        {
          ...
          Dimensionless const x[] = {
            0,  0.5, 1. - 1e-9, 1. + 1e-9, -1. - 1e-9, -1. + 1e-9, 1.1, -1.1,
            1e8  // break value
          };
