      ...
      class InterpolationTests : public CppUnit::TestFixture
      {
        ...
        void testIndexIterator()
        {
          LatticeVector vectors[] = {
            LatticeVector(4, 3, 2), LatticeVector(4, 3, 3), LatticeVector(4, 3, 4),
            LatticeVector(4, 4, 2), LatticeVector(4, 5, 2), LatticeVector(5, 3, 2),
            LatticeVector(6, 3, 2), LatticeVector(6, 5, 4),
          };
          size_t incs[] = {
            0,  1, 1, 1, 3, 3, 9, 8,
            666  // break
        ...
        void testOffLattice()
        {
          ...
          LatticeVector vectors[] = {
            LatticeVector(55, 51, 14), LatticeVector(55, 51, 15), LatticeVector(55, 51, 16),
            LatticeVector(55, 51, 17), LatticeVector(55, 52, 14), LatticeVector(56, 51, 14),
        ...
        void testOffLatticeZeroOutsideStencil()
        {
          ...
          LatticeVector zero_vecs[] = {LatticeVector(57, 53, 13), LatticeVector(57, 53, 18),
                                       LatticeVector(57, 50, 17), LatticeVector(57, 55, 17),
                                       LatticeVector(54, 53, 17), LatticeVector(59, 53, 17)};
        ...
        void testInterpolateQuadraticFunction()
        {
          ...
          Dimensionless const tolerance((quad(0, 0, 0) - quad(12, 12, 12)).GetMagnitude() * 1e-2);
        ...
        void velocityFromLatticeDataTester(bool doforce)
        {
          ...
          for (size_t index(0); index < N; ++index)
          {
            ...
            LatticeVelocity const momentum =
              LatticeVelocity(D3Q15::CX[2], D3Q15::CY[2], D3Q15::CZ[2]) * Dimensionless(position[0])
