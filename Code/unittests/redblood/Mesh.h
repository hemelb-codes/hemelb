    ...
    namespace redblood
    {
      ...
      class RedBloodMeshTests : public BasisFixture
      {
        ...
        void testScaling()
        {
          ...
          LatticePosition const first = (*original.GetVertices().begin() - original.GetBarycenter())
                                        * scale + original.GetBarycenter();
        ...
        void testTranslation()
        {
          ...
          CPPUNIT_ASSERT(
            helpers::is_zero(original.GetBarycenter() + offset - trans.GetBarycenter()));
